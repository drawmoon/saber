...
import io.github.drawmoon.saber.SqlGenerator;
...
public class BaseTestCase {
  ...
  public <T> void assertExpr(
      Function<RubikCube, SqlGenerator> func, Matcher<? super T> matcher, SqlDialect[] roots) {
  ...
  public <T> void assertExpr(
      Function<RubikCube, SqlGenerator> func, Matcher<? super T> matcher, SqlDialect root) {
